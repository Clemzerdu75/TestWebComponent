    ...
    return (
      <div class="Wrapper">
        ...
        <div class="OtherButtonWrapper">
          ...
          {/* Profil Button */}
          <mr-tooltip text="Profil Page" shortcut="P" class="Profil" position="left">
            <mr-little-button onClick={() => this.handleClick("Profil")}>
              <svg
          ...
          {/* Help Button */}
          <mr-tooltip text="Help Page" shortcut="H" class="Help" position="left">
            <mr-little-button onClick={() => this.handleClick("Help")}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
          ...
          {/* Logout Button */}
          <mr-tooltip text="Log Out" shortcut="Q" class="LogOut" position="left">
            <mr-little-button onClick={() => this.handleClick("LogOut")}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
