import { r as registerInstance, c as createEvent, h } from './index-ebcebcac.js';

const mrProfilButtonCss = ":host{display:block;width:150px;height:150px}h2{color:white;font-weight:700;font-size:30px}.Wrapper{position:relative;width:150px;height:150px;display:flex;align-items:center;justify-content:flex-end;}.Wrapper .MainButtonWrapper{z-index:2;width:60px;height:60px;display:flex;align-items:center;justify-content:center;border-radius:50%;border:solid 7px #f5f5f5;background:linear-gradient(145deg, #3db18e, #91ddc6);box-shadow:5px 5px 7px #cfcfcf, -5px -5px 7px #ffffff;transition:0.4s ease-in-out;transition-delay:0.2s;cursor:pointer}.Wrapper .OtherButtonWrapper{z-index:1;position:absolute;width:100%;height:100%;animation:enter 0.2s ease-in-out;transition:0.4s ease-in-out;}.Wrapper .OtherButtonWrapper .MixinButton,.Wrapper .OtherButtonWrapper .LogOut,.Wrapper .OtherButtonWrapper .Help,.Wrapper .OtherButtonWrapper .Profil{position:absolute;right:15px;top:54px;cursor:pointer}.Wrapper .OtherButtonWrapper .Profil{transition:transform 0.2s ease-in-out;transition-delay:0.2s}.Wrapper .OtherButtonWrapper .Help{transition:transform 0.3s ease-in-out;transition-delay:0.2s}.Wrapper .OtherButtonWrapper .LogOut{transition:transform 0.4s ease-in-out;transition-delay:0.2s}.Wrapper:hover .MainButtonWrapper{box-shadow:5px 5px 10px #c5c5c5;transform:scale(1.05);transition-delay:0s !important}.Wrapper:hover .OtherButtonWrapper{opacity:1}.Wrapper:hover .OtherButtonWrapper .Profil{transform:translate(-55px, -45px)}.Wrapper:hover .OtherButtonWrapper .Help{transform:translate(-73px, 0px)}.Wrapper:hover .OtherButtonWrapper .LogOut{transform:translate(-55px, 45px)}@keyframes enter{0%{opacity:0}90%{opacity:0}100%{opacity:1}}";
